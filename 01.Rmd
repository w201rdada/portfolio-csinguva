...
## Proposed Solution
To solve this problem, we plan to develop intelligent chatbots which can take SMS or voice questions from farmers in natural language and reply with real-time information reliably without manual intervention. The product/market segments are broken down as follows: 

![alt text](https://github.com/w201rdada/portfolio-csinguva/blob/master/img/Banners_and_Alerts_and_AgriTech.png)
...
#### d) Feedback Engine - New Questions: 
...
#### e) Learning by leveraging the crowd:
